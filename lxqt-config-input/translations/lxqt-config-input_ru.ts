...
<context>
    ...
    <message>
        ...
        <translation>Используйте настройки композитора Wayland для получения дополнительных опций мыши, сенсорной панели и клавиатуры.</translation>
    </message>
</context>
<context>
    <name>QObject</name>
...
Изменить параметры мыши, сенсорной панели или клавиатуры можно в настройка своего композитора.</translation>
    ...
    <message>
        ...
        <translation>Чтобы применить изменения также и к GTK, выберите Конфигурация внешнего вида LXQt → Стиль GTK.</translation>
    </message>
    <message>
