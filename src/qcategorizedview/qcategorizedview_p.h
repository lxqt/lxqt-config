...
class QCategoryDrawerV3;

/**
  * @internal
  */
class QCategorizedView::Private
{
public:
    struct Block;
    struct Item;

    Private(QCategorizedView *q);
    ~Private();
    ...
    QCategoryDrawer *categoryDrawer;
    QCategoryDrawerV2 *categoryDrawerV2;
    QCategoryDrawerV3 *categoryDrawerV3;
    int categorySpacing;
